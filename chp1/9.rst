...
**注**：在这一单元中（1.9），观察一个process究竟是recursive还是iterative可以直接根据if语句的<alter>项判断：recursive process的<alter>中，procedure自身是作为另一个procedure的parameter的；而iterative process的<alter>则完全由一个自身的procedure构成
